      ...
      <div className="garage">
        ...
        {cart.map((auto) => (
          <article className="cartItem">
            ...
            <div>
              ...
              <button onClick={() => remover(auto.modelo)}>
                Remover Lotus
              </button>
            </div>
          </article>
        ...
        {mostrar && (
          <form className="formPart">
            ...
            <h3>Gracias por su compra. Su total es ${totalPrice}USD y su número de orden es "{id}". Por favor guárdelo para poder hacer seguimiento de su pedido.</h3>
          </form>
        )}
      </div>
    );
